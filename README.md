│ AIRIA_CODE_CONFIGURATION_GUIDE.md                                                                                                 │
│                                                                                                                                   │
│ # Airia Code Configuration Guide                                                                                                  │
│                                                                                                                                   │
│ ## Overview                                                                                                                       │
│ Airia Code is a gateway-powered version of Claude Code that routes requests through an organization's Airia Gateway for enhanced  │
...
│ ```bash                                                                                                                           │
│ export ANTHROPIC_BASE_URL="https://prod-na.gateway.airiadev.ai/anthropic/"                                                        │
│ ```                                                                                                                               │
│                                                                                                                                   │
...
│ **For Zsh users (~/.zshrc):**                                                                                                     │
│ ```bash                                                                                                                           │
│ echo 'export ANTHROPIC_BASE_URL="https://prod-na.gateway.airiadev.ai/anthropic/"' >> ~/.zshrc                                     │
│ source ~/.zshrc                                                                                                                   │
│ ```                                                                                                                               │
│                                                                                                                                   │
│ **For Bash users (~/.bashrc):**                                                                                                   │
│ ```bash                                                                                                                           │
│ echo 'export ANTHROPIC_BASE_URL="https://prod-na.gateway.airiadev.ai/anthropic/"' >> ~/.bashrc                                    │
│ source ~/.bashrc                                                                                                                  │
│ ```                                                                                                                               │
│                                                                                                                                   │
│ **For other shells (~/.profile):**                                                                                                │
│ ```bash                                                                                                                           │
│ echo 'export ANTHROPIC_BASE_URL="https://prod-na.gateway.airiadev.ai/anthropic/"' >> ~/.profile                                   │
│ source ~/.profile                                                                                                                 │
│ ```                                                                                                                               │
│                                                                                                                                   │
...
│ ```powershell                                                                                                                     │
│ $env:ANTHROPIC_BASE_URL = "https://prod-na.gateway.airiadev.ai/anthropic/"                                                        │
│ ```                                                                                                                               │
│                                                                                                                                   │
│ **For Current Command Prompt Session Only:**                                                                                      │
│ ```cmd                                                                                                                            │
│ set ANTHROPIC_BASE_URL=https://prod-na.gateway.airiadev.ai/anthropic/                                                             │
│ ```                                                                                                                               │
│                                                                                                                                   │
...
│ **Using PowerShell:**                                                                                                             │
│ ```powershell                                                                                                                     │
│ [System.Environment]::SetEnvironmentVariable('ANTHROPIC_BASE_URL', 'https://prod-na.gateway.airiadev.ai/anthropic/', 'User')      │
│ ```                                                                                                                               │
│                                                                                                                                   │
│ **Using Command Prompt (Run as Administrator):**                                                                                  │
│ ```cmd                                                                                                                            │
│ setx ANTHROPIC_BASE_URL "https://prod-na.gateway.airiadev.ai/anthropic/"                                                          │
│ ```                                                                                                                               │
│                                                                                                                                   │
│ **Using GUI:**                                                                                                                    │
...
│ 6. Variable value: `https://prod-na.gateway.airiadev.ai/anthropic/`                                                               │
│ 7. Click OK                                                                                                                       │
│                                                                                                                                   │
│ ### Step 3: Configure API Key Storage                                                                                             │
│                                                                                                                                   │
...
│ @"                                                                                                                                │
│ {                                                                                                                                 │
│   "apiKeyHelper": "powershell.exe -Command \"(cmdkey /list:airia-api-key | Select-String                                          │
│ 'Password').ToString().Split(':')[1].Trim()\""                                                                                    │
│ }                                                                                                                                 │
│ "@ | Out-File -FilePath "$env:USERPROFILE\.claude\settings.json" -Encoding UTF8                                                   │
│ ```                                                                                                                               │
│                                                                                                                                   │
...
│ - Verify key format starts with `ak-`                                                                                             │
...
│ # Create settings                                                                                                                 │
│ New-Item -ItemType Directory -Force -Path "$env:USERPROFILE\.claude"                                                              │
│ '{"apiKeyHelper": "powershell.exe -Command $env:ANTHROPIC_API_KEY"}' | Out-File -FilePath                                         │
│ "$env:USERPROFILE\.claude\settings.json" -Encoding UTF8                                                                           │
│ ```                                                                                                                               │
│                                                                                                                                   │
│ ---                                                                                                                               │
│                                                                                                                                   │
